...
comment on table Tmp_Company is '公司';

comment on column Tmp_Company.foundDate is '成立时间';

comment on column Tmp_Company.extendInfo is '扩展信息';
...
alter table Tmp_Employee comment ='职员';
