<div class="page">
    <div class="pageContent">
        ...
        <div class="pageFormContent" layoutH="60">
			...
			<dl>
                <dt>性别：</dt>
                <dd><@s.select name="employee.sex" list=enums["education.portalpeng.enums.Sex"]?values listKey="value" listValue="text" cssClass="required combox" /></dd>
            </dl>
			<dl>
                <dt>兴趣爱好：</dt>
                <dd><@s.checkboxlist name="employee.interests" list=enums["education.portalpeng.enums.Interest"]?values listKey="text" listValue="text" /></dd>
            </dl>
        </div>
        <div class="formBar">
            <ul>
